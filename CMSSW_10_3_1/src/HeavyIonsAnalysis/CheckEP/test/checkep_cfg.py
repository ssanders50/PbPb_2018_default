...
process.load("HeavyIonsAnalysis.CheckEP/CheckEP_cfi")
...
process.CheckEP.trackTag_ = cms.InputTag("generalTracks")
process.CheckEP.vertexTag_ = cms.InputTag("offlinePrimaryVertices")
process.CheckEP.EP_ = cms.string("ALL")
process.p = cms.Path(process.hltSelect*process.collisionEventSelectionAODv2*process.centralityBin* process.hiEvtPlane * process.hiEvtPlaneFlat*process.CheckEP)
