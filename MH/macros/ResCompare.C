void ResCompare(string epname="HFm2"){
  ...
  TGraphErrors * rino = new TGraphErrors(Form("/home/sanders/PbPb_2015/MoveFlatParamsToDB/RescorSave/RescorTables_PbPb2015_263231_263359/%s_1.dat",epname.data()),"%lg%lg%lg%lf");
  double x[200];
  double y[200];
  double ey[200];
  ...
  rold->SetLineColor(kRed);
  rold->SetMarkerColor(kRed);
