...
namespace hi{
 ...
 public:
   TrackQuality(edm::InputTag trackTag_, double dz = 3, double d0 = 3, double pt = 0.1, double dzpix = 10, double d0pix=20, double chi2 = 40){
     ...
     chi2_ = chi2;
     std::cout<<"TrackQuality:        "<<trackType<<std::endl;
     std::cout<<"    dzdzerror_    :  "<<dzdzerror_<<std::endl;
     std::cout<<"    d0d0error_    :  "<<d0d0error_<<std::endl;
     std::cout<<"    pterror_      :  "<<pterror_<<std::endl;
