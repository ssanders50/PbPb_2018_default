...
process.hiEvtPlane.minet = cms.double(0.4)
...
process.evtPlaneCalibTree.trackTag = cms.InputTag("generalTracks");
process.evtPlaneCalibTree.nonDefaultGlauberModel = cms.string("")
process.evtPlaneCalibTree.flatnvtxbins_ = cms.int32(10)
process.evtPlaneCalibTree.flatminvtx_ = cms.double(-25.)
process.evtPlaneCalibTree.flatdelvtx_ = cms.double(5.)
process.evtPlaneCalibTree.dzdzerror_ = cms.untracked.double(3.0)
process.evtPlaneCalibTree.d0d0error_ = cms.untracked.double(3.0)
process.evtPlaneCalibTree.pterror_ = cms.untracked.double(0.1)
process.evtPlaneCalibTree.minet_ = cms.untracked.double(0.4)
...
#process.p = cms.Path(process.hltSelect*process.hiEvtPlane   )
